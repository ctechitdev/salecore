...
<body class="navbar-fixed sidebar-fixed" id="body">
                                                                                        ...
                                                                                        <div class="row p-2">
                                                                                            ...
                                                                                            <div class="col-lg-2">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text" step="any" name="bu_group[]" id="bu_group<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $row3['bu_group']; ?>" />
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-lg-2">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text" step="any" name="bu_unit[]" id="bu_unit<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $row3['bu_unit']; ?>" />
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-lg-2">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text" step="any" name="ma_group[]" id="ma_group<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $row3['ma_group']; ?>" />
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-lg-2">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text" step="any" name="article_group[]" id="article_group<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $row3['article_group']; ?>" />
                                                                                                </div>
                                                                                            </div>
    ...
    <script>
        ...
        $(document).on("submit", "#edititemfrm", function() {
            $.post("../query/edit-item-multi-price-group.php", $(this).serialize(), function(data) {
                if (data.res == "invalid") {
                    Swal.fire(
                        'ແຈ້ງເຕືອນ',
