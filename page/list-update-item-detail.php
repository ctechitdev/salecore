...
<body class="navbar-fixed sidebar-fixed" id="body">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                                    <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="text" name="itemid[]" id="itemid<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $row3['icl_id']; ?>" readonly />
    ...
    <script>
        ...
        $(document).on("submit", "#additemdate", function() {
            $.post("../query/add-item-update.php", $(this).serialize(), function(data) {
                if (data.res == "invalid") {
                    Swal.fire(
                        'ແຈ້ງເຕືອນ',
