															...
															<td>
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
																		<a class="dropdown-item" href="../pdf/print-add-item-pdf.php?item_id=<?php echo "$it_id"; ?>" target="_blank">ພິນລະຫັດສິນຄ້າ</a>

																		<?php

																		if ($role_id == 1) {
																		?>
																			<a class="dropdown-item" href="../export/export-item-data.php?item_id=<?php echo "$it_id"; ?>">ດາວໂຫລດ</a>
