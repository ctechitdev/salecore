                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check d-inline-block mr-3 mb-3">
                                                                    <input class="form-check-input" type="checkbox" value="<?php echo "$vendor_evaluated_id"; ?>" name="check_box[]" id="check_box<?php echo "$vendor_evaluated_id"; ?>">
                                                                    <label class="form-check-label" for="check_box<?php echo "$vendor_evaluated_id"; ?>">
