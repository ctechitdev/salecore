...
$header_name = "ເພິ່ມສິນຄ້າຫຼາຍກຸ່ມ-ລາຄາ";
$header_click = "2";
							...
							<div class="    ">
								<div class="email-right-column  email-body p-4 p-xl-5">
									<div class="email-body-head mb-6 ">
										<h4 class="text-dark">ເພິ່ມສິນຄ້າຫຼາຍກຸ່ມ-ລາຄາ</h4>




									</div>
									<form method="post" id="addmulitemfrm">
																...
																<div class="row">
																	...
																	<div class="col-lg-4">
																		<div class="form-group">
																			...
																			<input type="date" class="form-control" id="date_request" name="date_request" required>
																		</div>
																	</div>
																					...
																					<div class="row p-2">
																						...
																						<div class="col-lg-3">
																							<div class="form-group">
																								...
																								<input type="text" step="any" name="itemname[]" id="itemname<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>
																						...
																						<div class="col-lg-3">
																							<div class="form-group">
																								...
																								<input type="number" step="any" name="item_price_pur[]" id="item_price_pur<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>
																						...
																						<div class="col-lg-3">
																							<div class="form-group">
																								...
																								<input type="number" step="any" name="item_price_base[]" id="item_price_base<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>
																						...
																						<div class="col-lg-3">
																							<div class="form-group">
																								...
																								<select class="form-control" name="buy_unit[]" id="buy_unit<?php echo $x; ?>">
																									...
																									<?php
																									$stmt2 = $conn->prepare(" SELECT * from tbl_category_type  order by cat_name  ");
																									$stmt2->execute();
																									if ($stmt2->rowCount() > 0) {
																						...
																						<div class="col-lg-3">
																							<div class="form-group">
																								...
																								<input type="number" step="any" name="pack[]" id="pack<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>
																						...
																						<div class="col-lg-3">
																							<div class="form-group">
																								...
																								<input type="text" step="any" name="weight[]" id="weight<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>
																						...
																						<div class="col-lg-4">
																							<div class="form-group">
																								...
																								<input type="text" step="any" name="brand_name[]" id="brand_name<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>

																						<div class="col-lg-2">
																							<div class="form-group">
																								<label for="firstName">BG</label>
																								<input type="text" step="any" name="bu_group[]" id="bu_group<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>

																						<div class="col-lg-2">
																							<div class="form-group">
																								<label for="firstName">BU</label>
																								<input type="text" step="any" name="bu_unit[]" id="bu_unit<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>

																						<div class="col-lg-2">
																							<div class="form-group">
																								<label for="firstName">MAG</label>
																								<input type="text" step="any" name="ma_group[]" id="ma_group<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>

																						<div class="col-lg-2">
																							<div class="form-group">
																								<label for="firstName">AG</label>
																								<input type="text" step="any" name="article_group[]" id="article_group<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>
...
group by a.it_id
												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
															<a class="dropdown-item" href="edit-item-multi-price-group.php?item_id=<?php echo "$it_id"; ?>">ແກ້ໄຂ</a>
	...
	<script>
		// add item Data 
		$(document).on("submit", "#addmulitemfrm", function() {
			$.post("../query/add-item-multi-price-group.php", $(this).serialize(), function(data) {
				if (data.res == "invalid") {
					Swal.fire(
						'ແຈ້ງເຕືອນ',
			...
			$.ajax({
				...
				success: function(response) {
					...
					tr += '</select>' +
						...
						'<div class="form-group">' +
						'<label for="firstName">BG</label>' +
						'<input type="text" name="bu_group[]" id="bu_group' + count + '" autocomplete="off" class="form-control" />' +
						'</div>' +
						'</div>' +
						...
						'<div class="form-group">' +
						'<label for="firstName">BU</label>' +
						'<input type="text" name="bu_unit[]" id="bu_unit' + count + '" autocomplete="off" class="form-control" />' +
						'</div>' +
						'</div>' +
						...
						'<div class="form-group">' +
						'<label for="firstName">MAG</label>' +
						'<input type="text" name="ma_group[]" id="ma_group' + count + '" autocomplete="off" class="form-control" />' +
						'</div>' +
						'</div>' +
						...
						'<div class="form-group">' +
						'<label for="firstName">AG</label>' +
						'<input type="text" name="article_group[]" id="article_group' + count + '" autocomplete="off" class="form-control" />' +
						'</div>' +
						'</div>' +
