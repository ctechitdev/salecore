							...
							<div class="    ">
								<div class="email-right-column  email-body p-4 p-xl-5">
									<div class="email-body-head mb-6 ">
										<h4 class="text-dark">ເພິ່ມສິນຄ້າຫຼາຍລາຄາ</h4>
...
group by a.it_id
												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
															<a class="dropdown-item" href="edit-item-multi-price.php?item_id=<?php echo "$it_id"; ?>">ແກ້ໄຂ</a>
	...
	<script>
		...
		$(document).on("submit", "#addmulitemfrm", function() {
			$.post("../query/add-item-multi-price.php", $(this).serialize(), function(data) {
				if (data.res == "invalid") {
					Swal.fire(
						'ແຈ້ງເຕືອນ',
