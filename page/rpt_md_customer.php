                                        ...
                                        <div class="card-body">
                                            <table id="productsTable" class="table table-hover table-product" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    $stmt4 = $conn->prepare(" SELECT cus_code,c_shop_name,c_name,village,distict_name,time_check_in,
                                                    ...
                                                    where  date_check  between '$date_view_from' and '$date_view_to' and depart_id ='$depart_id' ");
                                                    $stmt4->execute();
