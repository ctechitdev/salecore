...
<body class="navbar-fixed sidebar-fixed" id="body">
																	...
																	<div class="form-group  col-lg-6">
																		...
																		<div class="form-group">
																			<select class=" form-control font" name="price_list" id="price_list">
																				...
																				<?php
																				$stmt4 = $conn->prepare(" SELECT * from tbl_price_list  order by pricelist_name ");
																				$stmt4->execute();
																				if ($stmt4->rowCount() > 0) {
																					while ($row4 = $stmt4->fetch(PDO::FETCH_ASSOC)) {
																				?> <option value="<?php echo $row4['b1_code']; ?>"> <?php echo $row4['pricelist_name']; ?></option>
																				<?php
																					}
																				}
																				?>
																					...
																					<div class="row p-2">
																						...
																						<div class="col-lg-3">
																							<div class="form-group">
																								...
																								<input type="number" step="any" name="item_price[]" id="item_price<?php echo $x; ?>" autocomplete="off" class="form-control" />
																							</div>
																						</div>
	...
	<script>
		...
		$(document).on("submit", "#additemfrm", function() {
			$.post("../query/additem.php", $(this).serialize(), function(data) {
				if (data.res == "invalid") {
					Swal.fire(
						'ແຈ້ງເຕືອນ',
