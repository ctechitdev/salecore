...
$insert = $conn->query("INSERT INTO tbl_item_post_customer (item_post_pic,item_code_list_id, full_code , item_name , item_pack_sale,item_status_sale, item_price,add_by,add_date) 
values ('$filename','$item_id','$b1_code','$item_name','$sale_unit','1','$item_price','$id_users',now()) ");
if ($insert) {
