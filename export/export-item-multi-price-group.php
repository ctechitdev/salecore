...
$objPHPExcel->getActiveSheet()->SetCellValue('AD1', 'U_BG');
$objPHPExcel->getActiveSheet()->SetCellValue('AE1', 'U_BU');
$objPHPExcel->getActiveSheet()->SetCellValue('AF1', 'U_MAG');
$objPHPExcel->getActiveSheet()->SetCellValue('AG1', 'U_AG');
...
$objPHPExcel->getActiveSheet()->SetCellValue('AD2', 'U_BG');
$objPHPExcel->getActiveSheet()->SetCellValue('AE2', 'U_BU');
$objPHPExcel->getActiveSheet()->SetCellValue('AF2', 'U_MAG');
$objPHPExcel->getActiveSheet()->SetCellValue('AG2', 'U_AG');
